...
async function testing() {
  ...
  console.log(
    "getProducts después de agregar los productos:",
    await productManagerInstance.getProducts()
  );
  ...
  console.log(
    "Listado de productos tras agregar un producto nuevo:",
    productsAfterAdd
  );
  ...
  await productManagerInstance.updateProduct(
    productIdToUpdate,
  ...
  console.log(
    "Listado de productos tras de actualizar un producto:",
    productsAfterUpdate
  );
  ...
  console.log(
    "Listado de productos tras eliminar un producto:",
    productsAfterDelete
  );
}
